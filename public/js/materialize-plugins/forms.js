    ...
    $(this).each(function(){
      ...
      var appendOptionWithIcon = function(select, option, type) {
        ...
        if (!!icon_url) {
          ...
          if (type === 'multiple') {
            options.append($('<li class="' + disabledClass + '"><images src="' + icon_url + '"' + classString + '><span><input type="checkbox"' + disabledClass + '/><label></label>' + option.html() + '</span></li>'));
          } else {
            options.append($('<li class="' + disabledClass + '"><images src="' + icon_url + '"' + classString + '><span>' + option.html() + '</span></li>'));
          }
          return true;
        }
      ...
      // Allow user.js to search by typing
      ...
      var filterQuery = [],
          onKeyDown = function(e){
            ...
            // Automaticaly clean filter query so user.js can search again by starting letters
