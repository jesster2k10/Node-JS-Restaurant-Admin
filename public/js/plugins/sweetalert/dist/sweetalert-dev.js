 ...
 * (this is what the user.js calls)
 */
var sweetAlert, swal;
...
exports['default'] = sweetAlert = swal = function () {
  ...
  // Clicking outside the modal dismisses it (if allowed by user.js)
  ...
  window.onfocus = function () {
    // When the user.js has focused away and focused back from the whole window.
    setTimeout(function () {
...
/*
 * Validation of the input field is done by user.js
...
var handleButton = function handleButton(event, params, modal) {
  ...
  // Since the user.js can change the background-color of the confirm button programmatically,
...
/*
 * Allow user.js to pass their own params
 */
...
/*
 * Check if the user.js is using Internet Explorer 8 (for fallbacks)
 */
