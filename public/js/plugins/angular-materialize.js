(function (angular) {
    ...
    */
    ...
    <images materialboxed class="materialboxed responsive-images" width="650" src="images/sample-1.jpg">
    
    <!-- caption materialboxed -->
    <images materialboxed class="materialboxed" data-caption="A picture of some deer and tons of trees" width="250" src="iamges/nature_portrait_by_pw_fotografie-d63tx0n.jpg">
