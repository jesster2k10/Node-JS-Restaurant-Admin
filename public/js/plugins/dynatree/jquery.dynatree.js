...
//      this.tree.logDebug("dtnode.deactivate(): %o", this);
	...
	_userActivate: function() {
		// Handle user.js click / [space] / [enter], according to clickFolderMode.
		var activate = true;
		var expand = false;
...
//      return !handled;
	...
	_onKeypress: function(event) {
		// onKeypress is only hooked to allow user.js callbacks.
...
//          helper.removeClass("dynatree-drop-hover");
	...
	_onDragEvent: function(eventName, node, otherNode, event, ui, draggable) {
		...
		case "helper":
			...
			var $helper = $("<div class='dynatree-drag-helper'><span class='dynatree-drag-helper-images' /></div>")
