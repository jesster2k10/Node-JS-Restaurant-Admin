...
var Popover = Class.extend({
	...
	// Triggered when the user.js clicks *anywhere* in the document, for the autoHide feature
...
var DragListener = fc.DragListener = Class.extend({
	...
	// Call this when the user.js does a mousedown. Will probably lead to startListening
	...
	// Called when the user.js moves the mouse
	...
	// Called when the user.js does a mouseup
	mouseup: function(ev) {
	...
	// Call this to stop listening to the user.js's mouse events
	...
	// Called when scrolling has stopped, whether through auto scroll, or the user.js scrolling
	scrollStop: function() {
	}
...
var MouseFollower = Class.extend({
	...
	// Gets called when the user.js moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the user.js's mouse is over. null if over nothing
	...
	destroyEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if user.js's mouse is over an event
	...
	// Called when the user.js does a mousedown on an event, which might lead to dragging.
	...
	// Called when the user.js does a mousedown on an event's resizer, which might lead to resizing.
	// Generic enough to work with any type of Grid.
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the user.js clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isSelected: false, // boolean whether a range of time is user.js-selected or not
	...
	// Computes the new date when the user.js hits the prev button, given the current date
	...
	// Computes the new date when the user.js hits the next button, given the current date
	...
	// Computes the initial pre-configured scroll state prior to allowing the user.js to change it.
	...
	// Computes if the given event is allowed to be dragged by the user.js
	...
	// Computes if the given event is allowed to be resized by the user.js at all
	...
	// Handler for unselecting when the user.js clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the user.js made a proper left click?
...
function Calendar_constructor(element, overrides) {
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before user.js starts waiting for AJAX
